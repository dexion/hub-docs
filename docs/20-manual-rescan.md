# Перепроверка находок и автоматическое закрытие
...
- [05. Справочник переменных окружения](05-configuration.md) — полный список новых env'ов с дефолтами
- [07. Jira](07-integration-jira.md) — настройки `auto_verify_close_comment` и `auto_verify_close_transition`
- [19. Troubleshooting](19-troubleshooting.md) — что делать, если кнопки не показались или сканер не отвечает
